...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("org.generation.blogPessoal.controller")) //MAPEAMENTO DOS CONTROLLERS
	...
	public static ApiInfo metadata() {       //DEFINE TITULO, DESCRICAO, VERSÃO, DADOS P/CONTATO...
		return new ApiInfoBuilder()
		.title("API - Blog Pessoal")
		.description("Projeto API Spring - Blog Pessoal")
		.version("1.0.0")
		.license("Apache License Version 2.0")
		.licenseUrl("https://github.com/viniciuscsf1")
		.contact(contact())
		.build();
	}
	
	private static Contact contact() {		//DADOS DO MEU CONTATO
		return new Contact("Vinicius Cardoso",
		"https://github.com/viniciuscsf1",
		"vinicius130196@gmail.com");
	}
		
	private static List<Response> responseMessage() {		//ESCREVE RESPOSTAS PERSONALIZADAS PARA OS VERBOS
